const char* ssid     = "AnnmonRajiJames";   //your network SSID
const char* password = "helloworld";   //your network password
int IRpin = 13;
int state = LOW;
String myScript = "/macros/s/AKfycbz7il3kuW64hkSSHXE90oi8xVDfCtjObyc_tsTUgNBc3o-zcZtbQqIOyArtcxr1hixYbw/exec";    //Create your Google Apps Script and replace the "myScript" path.
...
String myFilename = "&myFilena me=ESP32-CAM.jpg";
